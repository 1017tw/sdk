...
static int  uvc_bulk_init(uvc_param_t *param)
{
    ...
    if (EP0_DESC_SEL == 2 && param->usb_ext4_frame_resolution != NULL)
    {
        uvc_isoc_cam_set_yuyv_frame_desc(param->usb_ext4_frame_resolution, param->ext4_frame_resolution_num);
    }
