...
typedef void (*app_idle_cb_func_t)(void *param);

struct app_idle_callback {
    app_idle_cb_func_t func;
    void *priv_data;
    struct list_head   list;
};

int xAppRegisterIdleCallback(app_idle_cb_func_t func, void *param);
