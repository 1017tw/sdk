...
```c
/**
    对输入的图像frame_in旋转90°， 详细使用场景见sdk/example/videoin例子
*/
 frame_buf_t *frame_rotate_ret = rotate_frame(frame_in, ROT_MOD_CLK_90, 0);
frame_mgr_decr_ref(frame_in);
frame_in = frame_rotate_ret;
```
