...
/* JPEG decoder*/
#define JPEG_DEC_BASE_ADDR       (0x20002000U)

/* JPEG decoder write DMA  */
#define JPEG_DEC_WDMA_BASE_ADDR  (0x20002180U)

/* JPEG decoder read DMA  */
#define JPEG_DEC_RDMA_BASE_ADDR  (0x20002200U)
...
/* GPIOA */
#define GPIOA_BASE_ADDR          (0x20074000U)

/* SPI0~1, QSPIS */
#define QSPIM0_BASE_ADDR         (0x20078000U)
#define SPIM1_BASE_ADDR          (0x20079000U)
#define QSPIM2_BASE_ADDR         (0x2007B000U)
...
/* UART5~8 */
#define UART5_BASE_ADDR          (0x20300000U)
#define UART6_BASE_ADDR          (0x20301000U)
#define UART7_BASE_ADDR          (0x20302000U)
#define UART8_BASE_ADDR          (0x20303000U)

/* GPIOB */
#define GPIOB_BASE_ADDR          (0x20304000U)

/* GPIOC */
#define GPIOC_BASE_ADDR          (0x20305000U)
